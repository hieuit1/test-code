// --- 1. DỮ LIỆU GIẢ LẬP (MOCK DATA) ---
        ...
        const renderTable = (data) => {
            ...
            if (data.length === 0) {
                tbody.innerHTML = '<tr><td colspan="8" class="text-center" style="padding: 40px; color: #6B7280;">Không tìm thấy dữ liệu phù hợp với bộ lọc</td></tr>';
                return;
            }
        ...
        function fetchContent() {
            ...
            const searchTerm = document.getElementById('searchData').value.toLowerCase().trim();
